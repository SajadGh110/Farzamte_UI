...
export class NoticeSms implements OnInit {
  dateform! : FormGroup;
  ...
  async ngOnInit(){
    ...
    if (this.getBroker() == 'Mobin' || this.getBroker() == 'Pishro' || this.getBroker() == 'Khobregan' || this.getBroker() == 'Pouyan' || this.getBroker() == 'demo')
      this.SetTime(30);
  }
