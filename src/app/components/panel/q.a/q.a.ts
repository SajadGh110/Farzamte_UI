...
export class QA implements OnInit {
  ...
  getIndicatorTitle(index: number): string {
    const titles: { [key: number]: string } = {
      1: 'شروع و پایان تماس نسبت به معیارهای تعیین شده',
      2: 'تمرکز، درک و شناسایی نیاز مشتری',
      3: 'دانش، ارائه مطلب، رفع مشکل',
      4: 'تیکت (ثبت و ارجاع)',
      5: 'تعامل، لحن و ادب حرفه ای',
      6: 'ثبت اطلاعات تماس (دلیل تماس ورودی، آیتم های مورد نیاز تماس های خروجی)',
      7: 'به کار بردن نام مشتری (ابتدای تماس یا در حین مکالمه)',
      8: 'مدت زمان تماس (راهکار اضافی یا مختصر بودن تماس)'
    };
    return titles[index] || '';
  }
}
